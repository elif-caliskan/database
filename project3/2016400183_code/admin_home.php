    ...
    <ul>
        <?php foreach($authors as $author): ?>
            ...
            <?php 
                ...
                <input type="button" onclick="window.location='/admin.php/?page=paper_of&id=<?php echo $author['author_id'];?>'" value="See All Papers"/>
                

                <input type="button" onclick="window.location='/admin.php/?page=coauthors_of&id=<?php echo $author['author_id'];?>'" value="Co-Authors"/>
                <input type="button" onclick="window.location='/admin.php/?page=update&id=<?php echo $author['author_id'];?>'" value="UPDATE"/>

                <input type="button" onclick="window.location='/admin.php/?page=delete&id=<?php echo $author['author_id'];?>'" value="DELETE"/>
...
<h3>Papers</h3>
<input type="button" onclick="window.location='/admin.php/?page=search_paper'" value="Search in Papers"/>
<?php
    ...
    <ul>
        <?php foreach($papers as $paper): ?>
            <li>
                ...
                <input type="button" onclick="window.location='/admin.php/?page=paper_read&id=<?php echo $paper['paper_id'];?>'" value="READ"/>
                <input type="button" onclick="window.location='/admin.php/?page=paper_update&id=<?php echo $paper['paper_id'];?>'" value="UPDATE"/>
                <input type="button" onclick="window.location='/admin.php/?page=paper_delete&id=<?php echo $paper['paper_id'];?>'" value="DELETE"/>
    ...
    <ul>
        <?php foreach($topics as $topic): ?>
            <li>
                ...
                ?>
                <input type="button" onclick="window.location='/admin.php/?page=paper_read&id=<?php echo $paper_sota['paper_id'];?>'" value="SOTA PAPER"/>
                <?php endif; ?>
                <input type="button" onclick="window.location='/admin.php/?page=paper_topic&id=<?php echo $topic['topic_id'];?>'" value="SEE ALL PAPERS"/>
                <input type="button" onclick="window.location='/admin.php/?page=topic_update&id=<?php echo $topic['topic_id'];?>'" value="UPDATE"/>
                <input type="button" onclick="window.location='/admin.php/?page=topic_delete&id=<?php echo $topic['topic_id'];?>'" value="DELETE"/>
